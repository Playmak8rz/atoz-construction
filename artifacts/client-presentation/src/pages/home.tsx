...
import { ArrowRight, CheckCircle2, ChevronDown, MoveRight } from "lucide-react";
    ...
    <div className="bg-background min-h-screen text-foreground overflow-hidden selection:bg-primary selection:text-primary-foreground">
      ...
      <AnimatedSection className="bg-card/30">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-5 order-2 lg:order-1">
            <SectionTitle 
              subtitle="01 — The First Impression" 
              title="Commanding Authority" 
            />
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <BrowserMockup 
              src={`${BASE_URL}/screenshots/home-desktop.jpg`} 
              alt="Home Desktop Mockup" 
            />
          </div>
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7">
            <BrowserMockup 
              src={`${BASE_URL}/screenshots/services-desktop.jpg`} 
              alt="Services Page Mockup" 
            />
          </div>
      ...
      <AnimatedSection className="bg-card/30">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <BrowserMockup 
              src={`${BASE_URL}/screenshots/projects-desktop.jpg`} 
              alt="Projects Page Mockup" 
            />
          </div>
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
          ...
          <div className="w-full md:w-[25%]">
            <BrowserMockup 
              src={`${BASE_URL}/screenshots/home-mobile.jpg`} 
              alt="Mobile Mockup" 
              isMobile
            />
          </div>
      ...
      <AnimatedSection className="bg-card/30">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7">
            <BrowserMockup 
              src={`${BASE_URL}/screenshots/about-desktop.jpg`} 
              alt="About Page Mockup" 
            />
          </div>
          <div className="lg:col-span-5">
            <SectionTitle 
              subtitle="05 — The Story" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 flex items-center justify-center">
             <div className="w-full max-w-sm">
                <BrowserMockup 
                  src={`${BASE_URL}/screenshots/contact-mobile.jpg`} 
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
            {[
              ...
              "Premium contractor positioning"
            ].map((point, i) => (
              <motion.div 
                key={i}
        ...
        <div className="container mx-auto px-6 text-center max-w-4xl">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Button size="lg" className="h-16 px-10 text-lg rounded-none w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground">
